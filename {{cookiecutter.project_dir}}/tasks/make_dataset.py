...
input_folder : str
    The path to the folder that contains the data to upload
output_folder : str
    The path inside the datastore where the data should be stored
"""
...
@click.option(
    '--output_folder', 
    help='The folder in the datastore where the dataset should be stored'
)
