...
location : str
    The data center location to deploy to
subscription_id : str
    The GUID of the subscription to deploy to

    You can find the subscription ID using the Azure CLI
    :code:`az account list` or by going to https://portal.azure.com/ and
    looking it up in your subscriptions list.
"""
...
@click.option(
    '--subscription_id', 
    help='GUID identifying the subscription you want to deploy to')
